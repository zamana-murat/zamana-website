...
- Stratejik karar memosu
- Senaryo planlama çerçevesi
- Ekip duyuru şablonları
- Zor konuşma hazırlık çerçevesi
- Yönetim kurulu / yatırımcı güncelleme yapısı
- Yönetim raporu anlatısı
- Belge özetleme (özet + 5 kilit nokta + 3 ima edilen karar)
- Pazar istihbarat brifingi
- Öncelik analiz çerçevesi
- Toplantı hazırlık brifingi
- Yeniden yapılanma iletişimi
- Paydaş haritalama belgesi
- M&A / ortaklık ön değerlendirme çerçevesi
...
- [Agents ve Subagents](../yetenekler/agents-subagents/) — Karmaşık analiz görevlerinde
- [Context ve Compaction](../yetenekler/context-compaction/) — Uzun belgeleri özetleme
- [İdari İşler](idari-isler/) — Yönetici asistanının Claude kullanımı
- [4D Çerçevesi](../prompting/4d-cercevesi/) — Düşünme ortağı Description boyutu

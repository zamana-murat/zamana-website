...
- Çözüm öneren empati metni hazırlar
- Telafi (compensation) önerisi sunar
...
Otel iletişim sorumlusu için temel yapı:
...
## Voice
- Sıcak ama profesyonel. Klişe ("değerli misafirimiz") yasak.
- Misafir adını selamlamada bir kez kullan, sonra tekrar etme.
...
- Yorum yanıtında: kişisel detaya değin (yorum içeriği)
- Acente yazışmasında: profesyonel ama sıcak, B2B kayıt
```

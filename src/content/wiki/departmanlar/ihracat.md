...
- Ticaret belgesi hazırlığı (LOI, FCO, SPA, CIS) zaman alıcı ve hataya açık
- Belgeleri farklı alıcı milliyetleri ve hukuk sistemleri için uyarlamak zor
- Pazar istihbarat raporları günler alıyor
- Incoterms, ödeme koşulları ve sevkiyat talimatları belgeler arası sıklıkla tutarsız
...
- **Miktar toleransı** (± %5, ± %10)
- **Kalite spesifikasyonu**
- **Fiyat ayarlama formülü**
- **Ödeme koşulları** (LC, TT, CAD)
- **Muayene hakları**
- **Mücbir sebep**
- **Tabi olunacak hukuk**
...
- Emtia tipine göre LOI şablonu
- FCO yapısı
- Soft Offer varyantları
- SPA madde kütüphanesi (miktar, kalite, fiyat, ödeme, muayene, mücbir sebep, tabi olunan hukuk)
- CIS formatı
- NCNDA şablonu
- Emtiaya göre pazar istihbarat raporu
- Alıcı sorgu yanıtı
- Pazarlık karşı teklif mektubu
- Şirket profili / kapasite bildirisi
- Broker briefing
- Sevkiyat talimatları
- Ödeme koşulları checklist'i
- Incoterms tutarlılık incelemesi
- Proforma fatura şablonu
- LC uyuşmazlık yanıt mektubu
- Emtia hedge pozisyon anlatısı

---
title: Claude Nedir?
description: "Claude, Anthropic tarafından geliştirilen bir yapay zeka asistanıdır. İş dünyasında neler yapabildiğini, ne yapmadığını ve ChatGPT'den ne ile ayrıldığını açıklıyoruz."
tags:
  - temeller
  - claude
  - anthropic
...
- **Claude bir arama motoru değildir.** Varsayılan olarak internete bakmaz. Güncel haberler, hisse fiyatları, bugünün döviz kuru — bunları doğrudan soramazsınız. (Web search skill'i ayrıca etkinleştirilmediği sürece.)
- **Claude bir veritabanı değildir.** İki hafta önceki konuşmanızı hatırlamaz. Her oturum sıfırdan başlar — CLAUDE.md gibi kalıcı hafıza dosyaları devreye girmediği sürece.
...
Aynı soruyu tersine çevirdiğimizde iş dünyası için değerli olan şeyler netleşir. Claude bir...

- **Düşünme ortağıdır.** Bir karar öncesinde varsayımlarınızı sorgular, kör noktalarınızı gösterir, "bu mantıklı mı?" sorusuna dürüst cevap verir. Çoğu yöneticinin ofisinde olmayan şey budur.
